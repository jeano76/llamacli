...
export function shineMultilineFrame(lines: string[], tick: number, speed = 6, bandWidth = 6, slantPerRow = 1): string {
  return lines
    .map((line, row) => {
...
export function shineMultilineFrameCount(lines: string[], speed = 6, slantPerRow = 1): number {
