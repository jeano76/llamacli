...
def _save_config(path: Path, laya_cfg: dict) -> None:
...
def cmd_gate(args: argparse.Namespace) -> int:
    ...
    questions = {"decision": {"prompt": prompt}}
...
def cmd_fastcheck(args: argparse.Namespace) -> int:
    ...
    result = systemone(endpoint_url, args.state or "", {args.question: {"prompt": args.text}},
