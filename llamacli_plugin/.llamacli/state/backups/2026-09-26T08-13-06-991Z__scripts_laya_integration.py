...
def cmd_fastcheck(args: argparse.Namespace) -> int:
    ...
    applies, prints "SHORTCIRCUIT\\n..." as the FIRST stdout line (reusing
    cmd_gate()'s banner wording). That first line is the only thing Node's
    runLayaGate reads: /^short-circuit$/i on stdout.split(/\\r?\\n/)[0] => skip.
